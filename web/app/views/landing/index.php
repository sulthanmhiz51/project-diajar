...
<div class="wrapper">
  <header>
    ...
    <a href="<?= BASEURL ?>/register" class="cta-button">Daftar Sekarang</a>
    <a href="<?= BASEURL ?>/login" class="cta-button secondary">Masuk</a>
  </header>
  ...
  <div class="main-gray-wrapper">
    <div class="main-content">
      ...
      <p>Di sini kamu bisa belajar banyak hal untuk meningkatkan skill dan pengetahuanmu dengan metode pembelajaran yang menyenangkan dan efektif.</p>

      <div class="features">
        <div class="feature-card">
          <div class="feature-icon"><i class="fas fa-graduation-cap"></i></div>
          <h3>Kursus Berkualitas</h3>
          <p>Materi pembelajaran disusun oleh para ahli di bidangnya untuk memastikan kamu mendapatkan pengetahuan terbaik.</p>
        </div>

        <div class="feature-card">
          <div class="feature-icon"><i class="fas fa-user-tie"></i></div>
          <h3>Pengajar Profesional</h3>
          <p>Belajar langsung dari praktisi dan akademisi yang berpengalaman di industri masing-masing.</p>
        </div>
